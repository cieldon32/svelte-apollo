    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(label, "for", "appointmentTime");
    			add_location(label, file$1, 32, 4, 694);
    			attr_dev(input, "type", "text");
    			add_location(input, file$1, 33, 4, 752);
    			attr_dev(button, "type", "submit");
    			add_location(button, file$1, 34, 4, 807);
    			add_location(form, file$1, 31, 2, 645);
    			attr_dev(main, "class", "svelte-100spp5");
    			add_location(main, file$1, 30, 0, 636);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*appointmentTime*/ ctx[0]);
    			append_dev(form, t2);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(form, "submit", prevent_default(/*addPatient*/ ctx[1]), false, true, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*appointmentTime*/ 1 && input.value !== /*appointmentTime*/ ctx[0]) {
    				set_input_value(input, /*appointmentTime*/ ctx[0]);
    			}
    		},
    		i: noop,
  ...
  `;
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	function input_input_handler() {
    		appointmentTime = this.value;
    		$$invalidate(0, appointmentTime);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ("appointmentTime" in $$props) $$invalidate(0, appointmentTime = $$props.appointmentTime);
    	};
    	...
    	return [appointmentTime, addPatient, input_input_handler];
    }
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$2, 34, 26, 793);
    			attr_dev(label0, "for", "name");
    			add_location(label0, file$2, 34, 2, 769);
    			attr_dev(input1, "type", "text");
    			add_location(input1, file$2, 35, 26, 867);
    			attr_dev(label1, "for", "role");
    			add_location(label1, file$2, 35, 2, 843);
    			attr_dev(input2, "type", "text");
    			add_location(input2, file$2, 36, 34, 949);
    			attr_dev(label2, "for", "password");
    			add_location(label2, file$2, 36, 2, 917);
    			attr_dev(button, "type", "submit");
    			add_location(button, file$2, 37, 2, 1003);
    			add_location(form, file$2, 33, 0, 725);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input1, /*role*/ ctx[1]);
    			append_dev(form, t3);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(form, "submit", prevent_default(/*onLogin*/ ctx[3]), false, true, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*role*/ 2 && input1.value !== /*role*/ ctx[1]) {
    				set_input_value(input1, /*role*/ ctx[1]);
    			}
  ...
  `;
    	...
    	async function onLogin(e) {
    		...
    		try {
    			...
    			console.error(error); // navigate("/", { replace: true });
    		}
    	}
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "type", "text");
    			add_location(input0, file$3, 31, 26, 785);
    			attr_dev(label0, "for", "name");
    			add_location(label0, file$3, 31, 2, 761);
    			attr_dev(input1, "type", "text");
    			add_location(input1, file$3, 32, 26, 859);
    			attr_dev(label1, "for", "role");
    			add_location(label1, file$3, 32, 2, 835);
    			attr_dev(input2, "type", "text");
    			add_location(input2, file$3, 33, 34, 941);
    			attr_dev(label2, "for", "password");
    			add_location(label2, file$3, 33, 2, 909);
    			attr_dev(button, "type", "submit");
    			add_location(button, file$3, 34, 2, 995);
    			add_location(form, file$3, 30, 0, 714);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(input1, "input", /*input1_input_handler*/ ctx[5]),
    					listen_dev(input2, "input", /*input2_input_handler*/ ctx[6]),
    					listen_dev(form, "submit", prevent_default(/*onRegister*/ ctx[3]), false, true, false)
    				];
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(nav, file$4, 21, 2, 447);
    			add_location(div, file$4, 26, 2, 567);
    		},
    		m: function mount(target, anchor) {
